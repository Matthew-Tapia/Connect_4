...
void DPiece::updateColor() {
    ...
    if(color == RED){
        setFillColor(Constants::RED_PIECE_COLOR);
    } else if (color == YELLOW){
        setFillColor(Constants::YELLOW_PIECE_COLOR);
    } else if(color == NULL_COLOR){
        setFillColor(sf::Color(Constants::BACKGROUND_COLOR));
    }
}
...
sf::Color DPiece::getFillColor() const {
    PieceColor color = piece.getColor();
    if(color == RED){
        return Constants::RED_PIECE_COLOR;
    } else if (color == YELLOW){
        return Constants::YELLOW_PIECE_COLOR;
    } else if(color == NULL_COLOR){
        return sf::Color(Constants::BACKGROUND_COLOR);
    }
}
