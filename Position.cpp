...
#ifndef CONNECT_4_POSITION_CPP
#define CONNECT_4_POSITION_CPP
...
void Position::right(const T &obj1, S &obj2, float spacing) {
    ...
    obj2.setPosition({b1.left + b1.width + spacing, b1.top});
}
...
void Position::center(const T &obj1, S &obj2) {
    ...
    obj2.setPosition({b1.left + b1.width/2 - b2.width/2, b1.top + b1.height/2 - b2.height/2});
}
...
void Position::top(const T &obj1, S &obj2, float spacing) {
    ...
    obj2.setPosition({b1.left, b1.top - b2.height - spacing});
}
